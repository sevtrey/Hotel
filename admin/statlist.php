...
if (!isset($pagetype)) $pagetype="page";
		...
		while (list($key,$value)=each($_POST))
		{
			...
			if ($_POST["C#$varCode"]=="on")
			{
				...
				if ($varName=="F")
				{
					...
					$resultupd = MYSQL_QUERY($sqlupd) or $err-=10; //die("ошибка редактирования:<br>$sqlupd<br>".mysql_error());
				}
			}
		}
	}
...
<table Border=0 CellSpacing=0 CellPadding=0 width=100%>
  <tr><td class=pageline>
     <div class=wmiddletext><a href="main.php">Администрирование сайта</a> &#187; Текстовые страницы</div>
  </td></tr>
</table>
&nbsp;
...
<table class=grayhead Border=0 CellSpacing=0 CellPadding=0 >
 <tr class=normaltext>
  <td><div><h4>Управление текстовыми страницами</h4></div></td>
...
<table Border=0 CellSpacing=0 class=pagebluetable CellPadding=0>
 ...
 <tr><td colspan=10 class=blueheadcolor><center><div class=normaltext>ДОБАВЛЕНИЕ СТРАНИЦЫ</div></center></td></tr>
...
<table Border=0 CellSpacing=0 class=pagebluetable CellPadding=0 >
 <tr><td class=lmenutext height=30 bgcolor=#ffffff align="center">СПИСОК ТЕКСТОВЫХ СТРАНИЦ</td></tr>
</table>
...
<table Border=0 CellSpacing=1 class=bluetable CellPadding=4 width=100%>
  <tr class=lmenutext align=center  height=20 bgcolor=#ffffff>
    <td width=20>&nbsp;</td>  
    <td  align=center ><?=SortTitle("Название страницы","static_title",$sortby,$sortdir);?></td>
    <td  align=center >Содержимое страницы</td>
    <td width=130 align=center >SEO информация</td> 
	<td width=60 align=center >Фотогалерея</td>
  </tr>
