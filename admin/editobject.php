...
if(!isAllowed("rread")) {die("У Вас недостаточно прав для просмотра этой страницы");}
    ...
    {       
        ...
        $query="update {$PREFFIX}_objects set
...
<table Border=0 CellSpacing=0 CellPadding=0 width=100%>
  <tr><td class=pageline>
     <div class=wmiddletext><a href="main.php">Администрирование сайта</a> &#187; <a href="objects.php">Портфолио</a></a></div>
  </td></tr>
</table>
&nbsp;
...
<table Border=0 CellSpacing=0 CellPadding=0 width=650>
 ...
 <tr>
  ...
  <table Border=0 CellSpacing=0 CellPadding=0>
     ...
     <tr><td class=lmenutext align=center colspan=5><a href="objects.php">[ назад ]</a><br><br><br></td></tr>
...
<table Border=0 CellSpacing=0 CellPadding=0 width=650>
 <tr><td height=10></td></tr>
     <tr><td class=lmenutext align=center><a href="objects.php">[ назад ]</a><br><br>
</table>
