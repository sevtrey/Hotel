...
$result=mysql_query($query) or die("Не могу добавить раздел:<br>$query<br>".mysql_error());
...
<table Border=0 CellSpacing=0 CellPadding=0 width=100%>
  <tr><td class=pageline>
     <div class=wmiddletext><a href="main.php">Администрирование сайта</a> &#187; <a>Разделы прайс-листа</a> </div>
  </td></tr>
</table>
&nbsp;
...
<table class=grayhead Border=0 CellSpacing=0 CellPadding=0 >
 <tr class=normaltext>
  <td ><div ><h4>Разделы прайс-листа</h4></div></td>
  <td align=right class=wmiddletext><a class=submenu onclick="displayform(this,'добавить раздел')">добавить раздел</a></td>
 </tr>
</table>
...
<table Border=0 CellSpacing=0 class=pagebluetable CellPadding=0>
 ...
 <tr><td colspan=10 class=blueheadcolor><center><div class=normaltext>ДОБАВИТЬ РАЗДЕЛ</div></center></td></tr>
...
?>    
       ...
       <tr>
        <td class=helptd>
             ...
             <div class=ssmalltext>
                Заполните поля формы и нажмите кнопку "добавить раздел". </a>
             </div>
 ...
 <tr><td colspan=3 height=1 bgcolor=#ffffff></td></tr>
 <tr><td colspan=10 id=blueheadcolor><center><input type=button onClick=Send('I') value='добавить раздел'  class=smalltext></td></tr>
</table>
</div>


<table Border=0 CellSpacing=0 class=pagebluetable CellPadding=0 >
     <tr><td class=lmenutext height=30 bgcolor=#ffffff align="center">СПИСОК РАЗДЕЛОВ ПРАЙС-ЛИСТА</td></tr>
</table>
...
<table Border=0 CellSpacing=1 class=bluetable CellPadding=4 width=100%>
  <tr class=lmenutext height=20 align=center bgcolor=#ffffff>
    ...
    <td><?=SortTitle("Наименование (англ)","type_name_en",$sortby,$sortdir);?></td>
    <td width="80"><?=SortTitle("Позиция","type_pos",$sortby,$sortdir);?></td>
    <td width="90"><?=SortTitle("Активность","type_active",$sortby,$sortdir);?></td>
    <td width=30>Список услуг</td>
    </tr>
...
<?php
  if($num_rows)
  {
    ...
    echo"<td><center><a href=\"price.php?type_code=$type_code&curr_page=$curr_page\"><img height='20' width='20' src='graph/down.gif' border=0 alt='Услуги раздела' ></a></td>";
    echo"</TR>\n";
    } //end for x
  } // if num_rows
?>
