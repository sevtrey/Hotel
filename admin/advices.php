...
if(!isAllowed("rpremium")) {die("У Вас недостаточно прав для просмотра этой страницы");}
...
$result=mysql_query($query) or $err=1;//die("Не могу добавить совет:".mysql_error());
...
{
if (confirm('Вы уверены, что хотите удалить совет?'))
 {
    document.data.oper.value=a;
    document.data.submit();
 }
...
<table Border=0 CellSpacing=0 CellPadding=0 width=100%>
  <tr><td class=pageline>
     <div class=wmiddletext><a href="main.php">Администрирование сайта</a> &#187; <a>Советы</a></div>
  </td></tr>
</table>
&nbsp;
...
<table class=grayhead Border=0 CellSpacing=0 CellPadding=0 >
 <tr class=normaltext>
  <td ><div ><h4>Советы</h4></div></td>
  <td align=right class=wmiddletext><a class=submenu onclick="displayform(this,'добавить совет')">добавить совет</a></td>
 </tr>
</table>
...
<table Border=0 CellSpacing=0 class=pagebluetable CellPadding=0>
 ...
 <tr><td colspan=10 class=blueheadcolor><center><div class=normaltext>ДОБАВИТЬ СОВЕТ</div></center></td></tr>
 <tr><td colspan=3 height=1 bgcolor=#ffffff></td></tr>
 <tr><td>
 <center>
 <table cellpadding=2  cellspacing=0>
 <tr height=30 >
    <td class=lmenutext>Название раздела:</td>
    <td width=5></td>
    <td><textarea name='type_name' type=text style="width:250px" rows=3 class=smalltext></textarea></td>
 </tr>
 <tr height=30 >
    <td class=lmenutext>Название раздела (англ):</td>
    <td width=5></td>
...
?>    
       ...
       <tr>
        <td class=helptd>
             ...
             <div class=ssmalltext>
                Заполните поля формы и нажмите кнопку "добавить совет". После добавления записи активируйте соответствующий совет.</a>
             </div>
 ...
 <tr><td colspan=3 height=1 bgcolor=#ffffff></td></tr>
 <tr><td colspan=10 id=blueheadcolor><center><input type=button onClick=Send('I') value='добавить совет'  class=smalltext></td></tr>
</table>
</div>


<table Border=0 CellSpacing=0 class=pagebluetable CellPadding=0 >
 <tr><td class=lmenutext height=30 bgcolor=#ffffff align="center">СОВЕТЫ</td></tr>
</table>
...
<table Border=0 CellSpacing=1 class=bluetable CellPadding=4 width=100%>
  <tr class=lmenutext height=20 align=center bgcolor=#ffffff>
    <td width=20>&nbsp;</td>
    <td><?=SortTitle("Заголовок","type_name",$sortby,$sortdir);?></td>
    <td><?=SortTitle("Заголовок (англ)","type_name",$sortby,$sortdir);?></td>
