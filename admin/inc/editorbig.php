...
<script language="javascript" type="text/javascript">
        tinyMCE.init({
                ...
                plugins : "table,insertdatetime,preview,searchreplace,print,contextmenu,paste",
                ...
                theme_advanced_buttons3_add : "code,separator,print",

                theme_advanced_disable: "cleanup,help,formatselect,anchor,code,image",
